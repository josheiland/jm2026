...
export const POIS: Poi[] = [
  ...
  },
  {
    ...
    desc: 'Sandwiches on the Corner, and the reason nobody at UVA can describe a normal sandwich any more. Get the special sauce.',
  },
  {
    name: 'The Local',
    category: 'Eat & Drink',
    address: '824 Hinton Avenue',
    desc: 'Where we had our first real date',
  },
  {
    name: 'Luce',
    category: 'Eat & Drink',
    address: '110 2nd Street NW',
    desc: 'Hole in the wall pasta, which got picked up for a great many COVID picnics',
  },
  {
    name: 'Roots',
    category: 'Eat & Drink',
    address: '1329 West Main Street',
    desc: 'Grain bowls, five minutes on foot from the West Main hotels',
  },
  {
    name: 'Al Carbon',
    category: 'Eat & Drink',
    address: '365 Merchant Walk Square',
    desc: 'Charcoal rotisserie chicken, worth the short drive',
  },
  {
  ...
  },
  {
    ...
    desc: 'Jefferson’s Academical Village, and the best place in town to sit on grass',
  },
  {
    name: 'Engineer’s Way',
    category: 'See',
    address: 'Engineer’s Way',
    desc: 'Where we took most of our classes. Really not that nice, and Systems Engineering, which was ours, is the ugliest building on it.',
  },
  {
    name: 'High Energy Physics Building',
    category: 'See',
    address: 'McCormick Road, University of Virginia',
    desc: 'There is a climb up to the roof for the adventurous.',
  },
  {
    name: 'Ragged Mountain Running Shop',
    category: 'Move',
    address: '3 Elliewood Avenue',
    desc: 'Tell the Lorenzonis we sent you. They helped start Run Your City back in the day.',
  },
  {
    name: 'Lannigan Field',
    category: 'Move',
    address: 'Copeley Road, University of Virginia',
    desc: 'The track, where Mary put in the laps',
  },
  {
    name: 'Rivanna Trail',
    category: 'Move',
